            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Mitarbeiter bearbeiten</h3>
                    </div>
                    <form role="form" action="<?php base_url('users/create') ?>" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Vorname" value="<?php echo $user_data['vorname'] ?>" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="lastname">Nachname</label>
                                <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Nachname" value="<?php echo $user_data['name'] ?>" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" id="birthday" name="birthday" placeholder="Datum eintragen" value="<?php echo $user_data['geburtsdatum'] ?>" autocomplete="off">
                                </div>
                            </div>
