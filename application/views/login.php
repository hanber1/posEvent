...
<head>
    ...
    <title>Anmelden | Festverrechnung <?php  ?> </title>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url('auth'); ?>"><b>Festverrechnung <?php  ?> </b></a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            <p class="login-box-msg">Zur Anwendung bitte anmelden</p>
            ...
            <form action="<?php echo base_url('auth/login') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="eventday" name="eventday">
                        <option value="0" selected>Festtag auswählen ....</option>
                        <?php foreach ($eventday_data as $k => $v) : ?>
