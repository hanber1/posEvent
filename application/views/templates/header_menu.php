<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <!-- <span class="logo-mini"><b>Fest</b></span> -->
        <!-- logo for regular state and mobile devices -->
        <!-- <span class="logo-lg"><b>Festverrechnung</b></span> -->
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <!--    <a href="#">
                      ...
                      <div class="progress xs">
                        <div class="progress-bar progress-bar-yellow" style="width: 20%" role="progressbar"
                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
